...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 12 Okt 2023 pada 23.46
...
--
-- Dumping data untuk tabel `quacat`
--
...
--
-- Dumping data untuk tabel `quans`
--
...
(40, 'apa ya', 'aku<br>or<br>hi<br>or<br>hai', 'realistic.pain', 'syifanlfh'),
(41, 'mau', 'home', 'syifanlfh', 'syifanlfh'),
(42, 'what is database', NULL, 'syifanlfh', NULL),
(43, 'database', NULL, 'syifanlfh', NULL);
...
(22, 'memblee', '$2y$10$HdcBVC8bvbC8y0oqKehdHO1EkBBIJ8EsdpkP0gxvbrlCbqNIvI72G', 'mall', 'akmal@doi', '2023-10-11 12:05:24'),
(21, 'mooo', '$2y$10$2BxDqiXlJwEHVXyb9jDNI.hwKrLpdC0c1qziofbsr2COYhXwLkHj2', 'mall', 'nessanastasia14@gmail.com', '2023-10-10 13:36:32'),
(13, 'pjain', '$2y$10$iMvJcCrkuDaeaquwzjZZjehRFCdGrojkchTCLnJtihG6GNtviohjq', 'Prakhar Jain', 'pjain@gmail.com', '2017-03-30 17:09:07'),
(19, 'realistic.pain', '$2y$10$4znnXQysPSWdvoVIBaiHaOTVYOZn7/GMnsRXNPtsDEDZKBdVO/5ei', 'rea', 'syifakenari12@gmail.com', '2023-10-07 03:58:58'),
...
(20, 'syifanlfh', '$2y$10$nlbD76aYG4Sfol3BN17ufOQBxuo8sUuSHCteRAhMKY/pv57HbX2FW', 'nessa', 'fellacee@mail.com', '2023-10-08 05:52:42'),
...
--
-- AUTO_INCREMENT untuk tabel `quans`
--
ALTER TABLE `quans`
...
--
-- Ketidakleluasaan untuk tabel `quacat`
--
ALTER TABLE `quacat`
...
--
-- Ketidakleluasaan untuk tabel `quans`
--
ALTER TABLE `quans`
